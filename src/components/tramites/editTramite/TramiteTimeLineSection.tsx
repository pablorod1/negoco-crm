      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="space-y-1">
            ...
            <p className="font-medium ">{formatDate(tramite.creation_date)}</p>
          </div>
          <div className="space-y-1">
                  ...
                  <div className="max-w-sm flex items-start gap-2">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-primary-500">
                        La fecha de tramitación se asignará cuando el estado del
                        trámite cambie a <strong>Verificado</strong>.
                      </p>
                    </div>
                  </div>
                }
                ...
                content={
                  <div className="max-w-sm flex items-start gap-2">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-primary-500">
                        La fecha de activación se asignará cuando el estado del
